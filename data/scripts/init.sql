...
CREATE TABLE IF NOT EXISTS `nxt_doctor_type` (
  ...
  `doctor_type_status` TINYINT(1) NOT NULL DEFAULT 1,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `created_by` varchar(100) NOT NULL,
  `updated_at` datetime DEFAULT NULL ON UPDATE current_timestamp(),
  `updated_by` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `nxt_lab_invoice` (
  ...
  `invoice_delete` TINYINT(1) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `nxt_lab_report` (
  ...
  `report_delete` TINYINT(1) NOT NULL DEFAULT 1,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `created_by` varchar(100) NOT NULL,
  `updated_at` datetime DEFAULT NULL ON UPDATE current_timestamp(),
  `updated_by` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `nxt_patient` (
  ...
  `patient_mobile` varchar(15) NOT NULL,
  `patient_password` varchar(100) NOT NULL DEFAULT '$2a$10$G6BADZ8K89gZgsh9K1mg2.7KwWJz0H54p6sMXhJV5Bnq1OX68O7GC',
  ...
  `patient_delete` TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `nxt_service_slip` (
  ...
  `slip_paid` int(11) NOT NULL DEFAULT 0,
  `slip_balance` int(11) NOT NULL DEFAULT 0,
  `slip_delete` TINYINT(1) NOT NULL DEFAULT 1,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `created_by` varchar(50) NOT NULL,
  `updated_at` datetime DEFAULT NULL ON UPDATE current_timestamp(),
  `updated_by` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `nxt_slip_subtype` (
  ...
  `slip_subtype_status` TINYINT(1) NOT NULL DEFAULT 1,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `created_by` varchar(100) NOT NULL,
  `updated_at` datetime DEFAULT NULL ON UPDATE current_timestamp(),
  `updated_by` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `nxt_slip_type` (
  ...
  `slip_type_status` TINYINT(1) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `nxt_user` (
  ...
  `user_salary` VARCHAR(20) DEFAULT NULL,
